...
;
normal_class_declaration:
  modifier.multiopt  TOK_class  type_IDENTIFIER  type_parameters.opt class_extends.opt class_implements.opt class_permits.opt class_body
;
type_parameters.opt:
  type_parameters
| /*empty*/
...
;
field_declaration:
  modifier.multiopt unann_type variable_declarator_list TOK_59
;
...
;
enum_declaration:
  modifier.multiopt TOK_enum type_IDENTIFIER class_implements.opt enum_body
;
enum_body:
...
;
enum_constant:
  enum_modifier.multiopt IDENTIFIER TOK_91 TOK_40 argument_list.opt TOK_41 TOK_93 class_body.opt
;
...
;
record_declaration:
  modifier.multiopt TOK_record type_IDENTIFIER type_parameters.opt record_header class_implements.opt record_body
;
record_header:
...
;
normal_interface_declaration:
  modifier.multiopt TOK_interface type_IDENTIFIER type_parameters.opt interface_extends.opt interface_permits.opt interface_body
;
...
;
annotation_interface_declaration:
  modifier.multiopt TOK_64 TOK_interface type_IDENTIFIER annotation_interface_body
;
...
;
annotation_interface_element_declaration:
  modifier.multiopt unann_type IDENTIFIER TOK_40 TOK_41 dims.opt default_value.opt TOK_59
;
default_value.opt:
  default_value
| /*empty*/
